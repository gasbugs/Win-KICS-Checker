...
.SYNOPSIS
    ...
    2. Installs required Windows Features (IIS, FTP, SNMP, DNS, etc.).
    3. Installs necessary PowerShell modules (PowerShellGet, IISAdministration).
    4. Verifies the installation and status of all components.
#>
